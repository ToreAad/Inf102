...
public class SortableLinkedList<E extends Comparable<E>> implements ISortableList<E> {
    ...
    public void swap(Node<E> a, Node<E> b) {
        /*
        * Swaps the references of two nodes.
        */
        E ref = a.reference;
    ...
    public static <E extends Comparable<E>> void addToStack(Stack.ListStack<SortableLinkedList<E>> ssStack,
        ...
        /*
        * Adds a list to the stack, but if there is a list of equal size on the top of stack merge it with the 
        * new list first.
        */
    ...
    public void sort() {
        /*
        * Sort the list  using bottom up merge sort. Done by manipulating the pointers of the nodes. Ugly but efficient.
        * See text for description of general algorithm.
        */
